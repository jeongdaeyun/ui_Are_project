...
def main(image_path_d):
    ...
    def capture_image():
        ...
        # 이미지 저장    
        cv2.imwrite('./static/save/original.jpg', bg_img)
        cv2.imwrite('./static/save/captured.jpg', frame)
        exit_program()
    ...
    # 배경 이미지 기본 로드
    img_paths = image_path_d
    img_list = os.listdir(img_paths)

    img_paths_edge = image_path_d + "_edge"
